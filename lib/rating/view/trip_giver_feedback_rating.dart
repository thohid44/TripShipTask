...
class TripGiverFeedBackRating extends StatefulWidget {
  String path;
  TripGiverFeedBackRating({super.key, required this.path});

  @override
  State<TripGiverFeedBackRating> createState() =>
      _TripGiverFeedBackRatingState();
}

class _TripGiverFeedBackRatingState extends State<TripGiverFeedBackRating> {
  var value = 1.0;
  var convertValue = 1;
                    ...
                    children: [
                                              ...
                                              Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Container(
                                                        child: Text(
                                                          "${trip.bids[index]['bidder_name'].toString()}",
                                                          style: TextStyle(
                                                            color: Colors.black,
                                                            fontSize: 13.sp,
                                                            fontWeight:
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Container(
                                                      child: Text(
                                                        "${trip.bids[index]['amount'].toString()}.TK",
                                                        style: TextStyle(
                                                            fontSize: 13.sp,
                                                            fontWeight:
                                                                FontWeight
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          ratingController.tripGiverFeedback(
                              bidderId: bidderId,
                              posterId: posterId,
                              bidId: bidId,
                              tripId: tripId,
